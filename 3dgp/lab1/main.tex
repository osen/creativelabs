...
First, lets begin by including the \Name{Glew} header file into our project.
...
Because \Name{Glew} loads the \Name{OpenGL} library at runtime we also
need to initialize it.  In your project, just after where you open the
\Name{SDL 2} window using \Command{SDL\_CreateWindow}, add the following
function calls.
