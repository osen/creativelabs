...
\Figure{example}{A screenshot of our \Name{OpenGL} program clearing the screen}{example}
...
\FigureFull{vao}{Diagram showing the relationship between VBOs, VAOs and shader programs}{vao}
